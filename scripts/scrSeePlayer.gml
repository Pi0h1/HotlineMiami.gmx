...
if scrCollisionLineExt(x,y,objPlayer.x,objPlayer.y,3,objWindowH,objWindowV,objFurniture) {reload=10 checkreload=30 chasex=objPlayer.x chasey=objPlayer.y alert=2} else alert=1
