...
draw_sprite_ext(sprELegs,legindex2,x+lengthdir_x(7,dir-45)+1,y+lengthdir_y(7,dir-45)+1,image_xscale,image_yscale,legdir,c_black,0.5)
...
draw_sprite_ext(sprELegs,legindex2,x+lengthdir_x(7,dir-45),y+lengthdir_y(7,dir-45),image_xscale,image_yscale,legdir,image_blend,image_alpha)
