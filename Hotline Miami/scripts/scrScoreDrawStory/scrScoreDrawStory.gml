function scrScoreDrawStory() {
	...
	if finish = 1 draw_rectangle(__view_get( e__VW.WView, 0 ) / 2 - string_width(string_hash_to_newline(finishstring)) * 0.375 - 3, __view_get( e__VW.HView, 0 ) - 22, __view_get( e__VW.WView, 0 ) / 2 + string_width(string_hash_to_newline(finishstring)) * 0.375 + 3, __view_get( e__VW.HView, 0 ) + 3, 0)
	if update = 0 draw_set_font(fntScore)
	...
	if finish = 1 draw_text_transformed(__view_get( e__VW.WView, 0 ) / 2 + lengthdir_x(0.5, dir), __view_get( e__VW.HView, 0 ) - 11 + lengthdir_x(0.5, dir), string_hash_to_newline(finishstring), 0.75, 0.75, lengthdir_x(2, dir * 1.34 + 90))
	if ammoy > -32 draw_text_transformed(18 + string_width(string_hash_to_newline(ammostring)) * 0.5 + lengthdir_x(1, dir), __view_get( e__VW.HView, 0 ) - ammoy + lengthdir_y(1, dir), string_hash_to_newline(ammostring), 1, 1, lengthdir_x(2, dir * 1.34))

	draw_set_color(color2)

	if ammoy > -32 draw_text_transformed(18 + string_width(string_hash_to_newline(ammostring)) * 0.5 + lengthdir_x(1, dir - 180), __view_get( e__VW.HView, 0 ) - ammoy + lengthdir_y(1, dir - 180), string_hash_to_newline(ammostring), 1, 1, lengthdir_x(2, dir * 1.34 - 10))
	if finish = 1 draw_text_transformed(__view_get( e__VW.WView, 0 ) / 2 + lengthdir_x(0.5, dir - 180), __view_get( e__VW.HView, 0 ) - 11 + lengthdir_x(0.5, dir - 180), string_hash_to_newline(finishstring), 0.75, 0.75, lengthdir_x(2, dir * 1.34 + 100))
	if update = 0 draw_set_font(fntScore)
