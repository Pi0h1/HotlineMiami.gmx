...
if (state == 2) {
    ...
    if (!instance_exists(objPanther)) {
        if (global.maskindex == 16)
            SteamSetAchievement("ACH_CAT_FIGHT");
        state = 3;
    }
}
...
if (state == 4) {
    if (!instance_exists(objPhoneConversation)) {
        ...
        if (sprite_index == sprBoss4Shoot1) {
            ...
            if (image_index == 1 || image_index == 3 && frac(image_index) == 0) {
                if (ammo > 0) {
                    ammo--;
                    if (image_index == 1)
                        my_id = instance_create(x + lengthdir_x(32, image_angle - 100), y + lengthdir_y(32, image_angle - 100), objEBullet);
                    else my_id = instance_create(x + lengthdir_x(32, image_angle - 80), y + lengthdir_y(32, image_angle - 80), objEBullet);
        ...
        if (sprite_index == sprBoss4Reload1) {
            ...
            if (image_index > 1 && image_index < 1.15) {
        ...
        if (sprite_index == sprBoss4Shoot2) {
            ...
            if (dir < 0)
                dir += 360;
            image_angle = scrRotate(image_angle, dir, 4);
            if (image_index == 1 && frac(image_index) = 0) {
                if (ammo > 0) {
                    ammo--;
        ...
        if (sprite_index == sprBoss4Reload2) {
            ...
            if (image_index > 2 && image_index < 2.15) {
