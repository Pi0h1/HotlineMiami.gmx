	    ...
	    if (select == 0) {
	        ...
	        if (global.surfaces) {
	            ...
	            if (file_exists(working_directory + "\\surfaces"))
	                file_delete(working_directory + "\\surfaces");
	            if (file_exists(working_directory + "\\blood"))
	                file_delete(working_directory + "\\blood");
	        } else {
	            file = file_text_open_write(working_directory + "\\surfaces");
	            file_text_close(file);
	            file = file_text_open_write(working_directory + "\\blood")
	            file_text_close(file);
	        }
	    }
