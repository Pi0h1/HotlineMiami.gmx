function scrUpdateMaskPos(argument0) {
	var check;
	check = 0;


	if (argument0 == sprPPipeKill || argument0 == sprPKillCrowbar || argument0 == sprPTrophyKill || argument0 == sprPClubKill || argument0 == sprPBatKill || argument0 == sprPPoolKill || argument0 == sprPKillPan || argument0 == sprPKillPot || argument0 == sprPAxeKill) {
	...
	if (argument0 == sprPAttackPipe || argument0 == sprPAttackClub || argument0 == sprPAttackBat || sprite_index == sprPAttackCrowbar) {
	...
	if (argument0 == sprPAttackDoubleBarrel1 || argument0 == sprPAttackDoubleBarrel2) {
	    maskaddx[0] = 0 maskaddy[0] = -1;
	    maskaddx[1] = 0 maskaddy[1] = -1;
	    maskaddx[2] = 0 maskaddy[2] = -1;
	    maskaddx[3] = 0 maskaddy[3] = 0;
	...
	if (argument0 == sprPAttackBash || argument0 == sprPBashBodyguard || argument0 == sprBodyguardFinish2) {
	    maskaddx[0] = 12 maskaddy[0] = 0;
	...
	// default mask position, mostly used for walk cycles
	if (check == 0) {
	    maskaddx[0] = 0 maskaddy[0] = 0;
	    maskaddx[1] = 0 maskaddy[1] = -1;
	    maskaddx[2] = 0 maskaddy[2] = -1;
