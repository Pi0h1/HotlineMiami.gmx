...
if place_meeting(x,y-16,player)
{
if player.x<x {if image_angle>-90 {if angle_speed=0 sound_play(door_open) angle_speed=-5}} else {if image_angle<90 {if angle_speed=0 sound_play(door_open) angle_speed=5}}
}
if place_meeting(x+24,y,player) 
{
if image_angle>-90 {if angle_speed=0 sound_play(door_open) angle_speed=-5}
