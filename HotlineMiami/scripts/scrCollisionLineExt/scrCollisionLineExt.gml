function scrCollisionLineExt(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
	...
	if (cldist > 0)
	    repeats = round(cldist / argument4);
	else repeats = 0;
	...
	while (i < repeats) {
	    x += claddx;
	    y += claddy;
	    if (place_meeting(x, y, argument5) || place_meeting(x, y, argument6) || place_meeting(x, y, argument7))
	        test = true;
	    i++;
	}
	x = clstartx;
