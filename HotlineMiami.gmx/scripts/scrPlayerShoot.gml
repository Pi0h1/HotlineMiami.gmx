if (objPlayer.sprite_index == sprPLeaveBag || sprite_index == sprPWalkBossgun || objPlayer.sprite_index == sprPMaskSlip || instance_exists(objMaskMenu)) {
    // do nothing
} else {
    sprite = mask_index;
    ...
    if (reload <= 0) {
        ...
        if (ammo > 0) {
            ...
            if (sprite_index == sprPWalkDoubleBarrel) {
                ...
                if (ammo == 1)
                    sprite_index = sprPAttackDoubleBarrel1;
            ...
            if (sprite_index == sprPigButcherWalkMP5) {
                image_index = 0;
                sprite_index = sprPigButcherShoot;
            }
            if (sprite_index == sprPigButcherShoot) {
                if (image_index < 2)
                    ...
                    image_index = 2;
                    audio_play_sound(sndMP5, 0, false);
                    //scrHearPlayer() // 90% sure this was commented out to make filming the trailers was easier
                    ammo--;
                    reload = 2;
                    global.shake = 3;
                    if (place_meeting(x + lengthdir_x(12, dir), y + lengthdir_y(12, dir), objSolid) or place_meeting(x + lengthdir_x(12, dir), y + lengthdir_y(12, dir), objDoorV)) {
