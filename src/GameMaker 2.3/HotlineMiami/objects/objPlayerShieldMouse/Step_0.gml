...
if keyboard_check(ord(global.upkey)) scrMoveShieldUp();
if keyboard_check(ord(global.downkey)) scrMoveShieldDown();
if keyboard_check(ord(global.leftkey)) scrMoveShieldLeft();
if keyboard_check(ord(global.rightkey)) scrMoveShieldRight();
