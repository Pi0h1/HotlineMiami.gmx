...
draw_sprite_ext(sprEmployeeLegs, image_index * 2, x + 1, y + 1, image_xscale, image_yscale, angle, c_black, 0.5);
draw_sprite_ext(sprEmployeeLegs, image_index * 2, x, y, image_xscale, image_yscale, angle, image_blend, image_alpha);
