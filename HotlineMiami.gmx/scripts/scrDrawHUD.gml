...
if (finish)
    draw_rectangle(view_wview[0] / 2 - string_width(finishstring) * 0.375 - 3, view_hview[0] - 22, view_wview[0] / 2 + string_width(finishstring) * 0.375 + 3, view_hview[0] + 3, 0);
if (!update)
    draw_set_font(fntScore);
...
if (finish)
    draw_text_transformed(view_wview[0] / 2 + lengthdir_x(0.5, dir - 180), view_hview[0] - 11 + lengthdir_x(0.5, dir - 180), finishstring, 0.75, 0.75, lengthdir_x(2, dir * 1.34 + 100));
if (!update)
    draw_set_font(fntScore);
