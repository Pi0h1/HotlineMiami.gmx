if floor(index*0.5)=0 light=sprDanceFloorLight0
if floor(index*0.5)=1 light=sprDanceFloorLight1
if floor(index*0.5)=2 light=sprDanceFloorLight2
if floor(index*0.5)=3 light=sprDanceFloorLight3
if index<3.5 index+=0.5 else index=0
