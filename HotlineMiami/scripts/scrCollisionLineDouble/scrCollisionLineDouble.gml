function scrCollisionLineDouble(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
	...
	while (i < repeats) {
	    x += claddx;
	    y += claddy;
	    if (place_meeting(x, y, argument5) or place_meeting(x, y, argument6))
	        test = 1;
	    i++;
	}
	x = clstartx;
