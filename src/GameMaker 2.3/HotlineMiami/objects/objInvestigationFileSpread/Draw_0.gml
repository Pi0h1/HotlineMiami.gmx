if place_meeting(x,y,objPlayer) and seen=0 {
...
if seen=0 draw_sprite_ext(sprArrow,0,x+9+lengthdir_x(3,dir),y,image_xscale,image_yscale,-90,image_blend,image_alpha)
dir+=4
}
