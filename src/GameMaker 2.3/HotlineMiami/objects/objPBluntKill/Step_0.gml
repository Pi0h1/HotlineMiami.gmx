if global.xbox=1 scrXboxBluntKill()
if hurtindex=11 {
if image_index=0 {
...
if sprite_index=sprPKillPot my_id.sprite_index=sprPWalkPot
if sprite_index=sprPKillPan my_id.sprite_index=sprPWalkPan
if sprite_index=sprPKillCrowbar my_id.sprite_index=sprPWalkCrowbar
