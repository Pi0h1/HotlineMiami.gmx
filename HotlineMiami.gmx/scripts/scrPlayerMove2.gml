...
moveleft=keyboard_check_direct(ord("J")) || keyboard_check_direct(vk_left)
moveright=keyboard_check_direct(ord("L")) || keyboard_check_direct(vk_right)
moveup=keyboard_check_direct(ord("I")) || keyboard_check_direct(vk_up)
movedown=keyboard_check_direct(ord("K")) || keyboard_check_direct(vk_down)
