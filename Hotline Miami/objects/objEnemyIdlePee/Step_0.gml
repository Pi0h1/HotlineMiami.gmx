...
if room=rmTrainstationEntrance or room=rmBossClubFloor3 my_id=instance_create(x,y,objEnemyMeleeStationary) else my_id=instance_create(x,y,choose(objEnemy,objEnemyMeleeStationary))
my_id.alert=1
