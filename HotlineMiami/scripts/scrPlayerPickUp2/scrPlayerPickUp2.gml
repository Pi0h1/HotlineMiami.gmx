function scrPlayerPickUp2() {
	// This script is for picking up weapons

	release = 0;
	if (reload > 0)
	    exit;
	if (objPlayer.sprite_index == sprPWalkBag || objPlayer.sprite_index == sprPWalkBossgun || objPlayer.sprite_index == sprPLeaveBag || sprite_index == sprPTakePhone)
	    exit;
