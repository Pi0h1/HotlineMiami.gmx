...
if level = 3 {
    var txtTitle = "WARNING!";
    var txtMessage = "PLEASE UPDATE YOUR GAMEPAD DRIVERS#BEFORE ENABLING THIS FEATURE!#ARE YOU SURE YOU WANT TO PROCEED?";
    var txtMessage2 = "THE LATEST GAMEPAD DRIVERS CAN BE#DOWNLOADED FREE AT MICROSOFT.COM!";
    amount = 0.5 + lengthdir_x(0.5, dir * 10);
    draw_set_color(merge_color(c_white, c_aqua, amount));
    draw_text(x + 1, y + 56, string_hash_to_newline(txtTitle));
    amount = 0.5 - lengthdir_x(0.5, dir * 10)
    draw_set_color(merge_color(c_white, c_aqua, amount));
    draw_text(x, y + 56, string_hash_to_newline(txtTitle));
    draw_set_font(fntWarning);
    draw_set_color(c_black);
    draw_text(x + 1, y + 86, string_hash_to_newline(txtMessage));
    draw_text_color(x, y + 85, string_hash_to_newline(txtMessage), merge_color(c_white, c_yellow, 0.5 + lengthdir_x(0.5, dir * 10)), merge_color(c_white, c_yellow, 0.5 + lengthdir_x(0.5, dir * 10 + 90)), merge_color(c_white, c_yellow, 0.5 + lengthdir_x(0.5, dir * 10 + 180)), merge_color(c_white, c_yellow, 0.5 + lengthdir_x(0.5, dir * 10 + 270)), 1)

    draw_set_color(c_black);
    draw_text(x + 1, 215, string_hash_to_newline(txtMessage2));
    draw_set_color(c_white);
    draw_text(x, 214, string_hash_to_newline(txtMessage2));
    draw_set_font(fntMenu);
    start_x = 160;
    repeat(2) {
        if select = i {
