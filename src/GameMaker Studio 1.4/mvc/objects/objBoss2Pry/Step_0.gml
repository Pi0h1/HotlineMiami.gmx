...
global.test=0
with objPlayer {
if place_meeting(x+lengthdir_x(16,dir),y+lengthdir_y(16,dir),objBoss2Pry) global.test=1
}
if global.test=1 {
...
if energie=2 my_id.sprite_index=sprBoss2GetUp2
}
else {
...
if objPlayer.left=1 my_id2.direction=image_angle+70+random(40) else my_id2.direction=image_angle-70-random(40)
