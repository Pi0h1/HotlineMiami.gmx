...
draw_sprite_ext(sprAim,0,x+lengthdir_x(32,dir),y+lengthdir_y(32,dir),1,1,-__view_get( e__VW.Angle, 0 ),c_white,0.5)
draw_sprite_ext(sprCursor,objEffector.image_index,x+lengthdir_x(64,dir),y+lengthdir_y(64,dir),1,1,-__view_get( e__VW.Angle, 0 ),c_white,0.5)
