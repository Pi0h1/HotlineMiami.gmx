...
if sprite_index=sprDoctorPoint legindex=0 else legindex=image_index*2
draw_sprite_ext(sprELegs,legindex,x+1,y+1,image_xscale,image_yscale,direction,c_black,0.5)
draw_sprite_ext(sprELegs,legindex,x,y,image_xscale,image_yscale,direction,image_blend,image_alpha)
