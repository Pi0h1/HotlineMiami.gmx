...
if global.ending=1 instance_create(x,y,objFinalDialogue2) else instance_create(x,y,objFinalDialogue)
with objPlayerBikerHouse {legindex=0 active=0 aimon=0 dir=point_direction(x,y,324,128)}
active=0
}
}

if !instance_exists(objPlayerBiker) exit
...
if image_index<18 image_index+=0.1
}
