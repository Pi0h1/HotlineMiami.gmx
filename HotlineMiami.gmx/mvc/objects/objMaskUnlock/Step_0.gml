...
if (!on) {
    text = "NEW MASK";
    color = merge_color(c_maroon, c_purple, 0.2 + lengthdir_x(0.2, dir * 3.33)) + random(0.1);
} else {
    text = name[global.currentmask] color = merge_color(c_teal, c_navy, 0.2 + lengthdir_x(0.2, dir * 3.33) + random(0.1));
}
repeat(draws) {
