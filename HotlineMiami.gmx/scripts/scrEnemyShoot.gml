if (ammo > 0) {
    if (sprite_index == sprEWalkM16 || sprite_index == sprPoliceWalkM16 || sprite_index == sprSwatWalkM16) {
        if (reload > 0)
            reload--;
        else {
            shake = 1;
    ...
    if (sprite_index == sprEWalkShotgun || sprite_index == sprPoliceWalkShotgun) {
        if (reload > 0)
            reload--;
        else {
