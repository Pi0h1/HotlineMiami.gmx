...
draw_rectangle_color(camera_get_view_x(view_camera[0])-60,camera_get_view_y(view_camera[0])-60,camera_get_view_x(view_camera[0])+__view_get( e__VW.WView, 0 )+60,camera_get_view_y(view_camera[0])+__view_get( e__VW.HView, 0 )+60,color1,color1,color2,color2,0)
