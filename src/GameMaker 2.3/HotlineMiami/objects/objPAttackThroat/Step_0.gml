...
my_id.text="+"+string((kill)+bold*(scrGetFactor()))+"pts"
global.myscore+=(kill)+bold*(scrGetFactor())
global.killscore+=kill
global.boldscore+=bold*scrGetFactor()
...
my_id.sprite_index=sprEBackThroat
my_id.image_speed=.15
