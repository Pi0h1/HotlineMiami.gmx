...
if surface_exists(global.surf2) and global.surfaces=1 addToSurface(global.surf2,1)
}
}
}
exit
...
if life>0 {
life-=1
if image_index<7.3 image_index+=0.15 else image_index=0
} else {
if image_index<13 image_index+=0.15 else {if surface_exists(global.surf2) and !place_meeting(x,y,objBloodPool) and global.surfaces=1 addToSurface(global.surf2,1)}
}
exit
}
...
if image_index<6 image_index+=0.15 else {if surface_exists(global.surf2) and !place_meeting(x,y,objBloodPool) and global.surfaces=1 addToSurface(global.surf2,1)}
...
if life>0 {
life-=1
if image_index<3.3 image_index+=0.15 else image_index=0
...
if image_index<9 image_index+=0.15 else {if surface_exists(global.surf2) and !place_meeting(x,y,objBloodPool) and global.surfaces=1 addToSurface(global.surf2,1)}
}
exit
}
...
image_speed=0
if image_index<26 image_index+=0.15 else {if surface_exists(global.surf2) and !place_meeting(x,y,objBloodPool) and global.surfaces=1 addToSurface(global.surf2,1)}
...
image_speed=0
if image_index<19 image_index+=0.2 else {if surface_exists(global.surf2) and !place_meeting(x,y,objBloodPool) and global.surfaces=1 addToSurface(global.surf2,1)}
