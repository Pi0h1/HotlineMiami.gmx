...
scrSaveUnlocked();
global.newguns = 0;
if (global.ending == 0 && global.masks[18] == 0) {
    SteamSetAchievement("ACH_THATS_IT");
    global.sequence = rmMCSequence2Downstairs;
    global.newmask[global.newmasks] = 18;
    global.newmasks++;
    global.lastgrade = 0;
}
if (global.ending && global.masks[20] = 0) {
    SteamSetAchievement("ACH_THAT_IS_IT");
    global.sequence = rmMCSequence3Downstairs;
    global.newmask[global.newmasks] = 20;
    global.newmasks++;
    global.lastgrade = 0;
}
image_speed = 0;
