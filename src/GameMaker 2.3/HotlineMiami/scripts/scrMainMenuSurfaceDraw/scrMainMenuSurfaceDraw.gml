function scrMainMenuSurfaceDraw() {
	if surface_exists(global.surf1) {
	    ...
	    draw_text(x - 1, y, string_hash_to_newline(txtErrorMessage));
	    draw_text(x + 1, y, string_hash_to_newline(txtErrorMessage));
	    draw_text(x, y + 1, string_hash_to_newline(txtErrorMessage));
	    draw_text(x, y - 1, string_hash_to_newline(txtErrorMessage));
	    draw_set_color(c_white)
	    draw_text(x, y, string_hash_to_newline(txtErrorMessage));
	}
