function scrGetSequence(argument0) {
	//
	switch (argument0) {
	    case rmSequence1:
	    ...
	    case rmSequence3:
	        ...
	        return rmVideoStore1;
	    case rmSequence4:
	        global.parttitle[0] = "PART TWO.";
	        global.parttitle[1] = "QUESTIONS.";
	        global.nextlevel = rmDream2;
	        global.sequence = rmPart;
	        return rmBar1;
	    ...
	    case rmSequence7:
	        ...
	        return rmVideoStore2;
	    case rmSequence8:
	        global.parttitle[0] = "PART THREE.";
	        global.parttitle[1] = "VISITATIONS.";
	        global.nextlevel = rmDream3;
	        global.sequence = rmPart;
	        return rmBar2;
	    ...
	    case rmSequence11:
	        ...
	        return rmVideoStore3;
	    case rmSequence12:
	        global.parttitle[0] = "PART FOUR.";
	        global.parttitle[1] = "CONNECTIONS.";
	        global.nextlevel = rmSequence12bDownstairs;
	        global.sequence = rmPart;
	        return rmBar3;
        
	    case rmSequence12bDownstairs:
	    ...
	    case rmMCSequence3:
	        ...
	        return global.sequence;
	    case rmMCSequence4:
	        global.sequence = rmBikeEnding;
	        song = "ANewMorning.mp3";
	        return global.sequence;
	    case rmChapter:
	        global.sequence = rmMenu;
	        song = working_directory + "\\HorseSteppin.mp3";
	        return global.sequence;
	}
