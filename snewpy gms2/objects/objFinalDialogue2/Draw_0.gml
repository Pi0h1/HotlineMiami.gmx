...
draw_sprite_ext(index,dir*0.1,camera_get_view_width(view_camera[0])-phonex+128+2,camera_get_view_height(view_camera[0])/2+3,image_xscale,image_yscale,lengthdir_x(4,dir*1.67),c_black,0.5)
draw_sprite_ext(index,dir*0.1,camera_get_view_width(view_camera[0])-phonex+128,camera_get_view_height(view_camera[0])/2,image_xscale,image_yscale,lengthdir_x(4,dir*1.67),c_white,1)
if blackx=45 {
...
draw_text(15.5-lengthdir_x(0.5,dir*4),camera_get_view_height(view_camera[0])-58.5-lengthdir_x(0.5,dir*4),string_hash_to_newline(string_upper(line1[current])))
draw_text(15.5-lengthdir_x(0.5,dir*4),camera_get_view_height(view_camera[0])-40.5-lengthdir_x(0.5,dir*4),string_hash_to_newline(string_upper(line2[current])))
}
}
} else {
if blackx>0 {
