...
draw_sprite_ext(head,headindex,x+maddx,y+maddy,image_xscale,image_yscale,dir,image_blend,image_alpha)
...
draw_sprite_ext(head,headindex,x+maddx,y+maddy,image_xscale,image_yscale,dir,c_black,0.2)
d3d_set_fog(0,0,0,0)

d3d_set_fog(true,c_white,0,0)
draw_sprite_ext(head,headindex,x+maddx,y+maddy,image_xscale,image_yscale,dir,image_blend,0.1+lengthdir_x(0.1,goddir))
d3d_set_fog(0,0,0,0)
}
