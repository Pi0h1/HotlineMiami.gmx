...
if (global.my_id.image_index=0 or global.my_id.image_index=4) {
scrKnifeThrowHits()
ds_list_add(global.bonuslist,"Projectile Kill")
if global.bonustime<20 global.bonustime=20
exit
} 
if (global.my_id.image_index=1 or global.my_id.image_index=2) {
with global.my_id {
...
my_id.text="+"+string(500*scrGetFactor())+"pts"
global.myscore+=(500*scrGetFactor())
...
if (global.my_id.image_index=3 or global.my_id.image_index=5) {
audio_play_sound(sndDoorHit,0,false)
audio_play_sound(sndHit,0,false)
global.my_id.hits+=1
scrEnemyDieMelee(global.my_id.hits)
global.shake=6
if global.my_id.image_index=3 and global.my_id.bounce=1 SteamSetAchievement("ACH_PLAYING_POOL")
if global.bonustime<20 global.bonustime=10
if global.my_id.hits>=2 {
if global.my_id.hits=2 {ds_list_add(global.bonuslist,"Double Hit") SteamSetAchievement("ACH_TWO_BIRDS_WITH_ONE_STONE")}
if global.my_id.hits=3 {ds_list_add(global.bonuslist,"Triple Hit") SteamSetAchievement("ACH_PLAIN_LUCK")}
if global.my_id.hits>=4 {ds_list_add(global.bonuslist,"Multi Hit") SteamSetAchievement("ACH_PLAIN_LUCK")}
...
if sprite_index=sprEWalkUnarmed nothing=1 else {
my_id=instance_create(x,y-12,objScore)
my_id.text="+"+string(500*scrGetFactor())+"pts"
global.myscore+=(500*scrGetFactor())
global.boldscore+=(500*scrGetFactor())
...
if global.bonustime<32 global.bonustime=32
}
}
