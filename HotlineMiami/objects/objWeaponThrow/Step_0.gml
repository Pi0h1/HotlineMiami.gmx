        ...
        if (scrCantGetHit(object_index)) {
            ...
            if (place_meeting(x, y, global.my_id)) {
                if (object_index == objEnemyFat) {
                    global.my_id.direction = point_direction(x, y, global.my_id.x, global.my_id.y);
                    global.my_id.speed *= 0.8;
                    exit;
                }
                if (global.my_id.image_index == 5 && round(random(5)) < 4) {
                    if (global.my_id.bounce)
                    ...
                    if (global.maskindex == 24) {
                        ...
                        if (global.my_id.enemy)
                            SteamSetAchievement("ACH_DOMINO_EFFECT");
