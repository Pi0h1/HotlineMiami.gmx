...
direction=dir-180
if place_free(x+lengthdir_x(1,dir),y) and !scrMeetDoor(x+lengthdir_x(1,dir),y) x+=lengthdir_x(1,dir)
if place_free(x,y+lengthdir_y(1,dir)) and !scrMeetDoor(x,y+lengthdir_y(1,dir)) y+=lengthdir_y(1,dir)
image_speed=0.1
}
}
}
...
if !place_free(x+hspeed*4,y) or scrMeetDoor(x+hspeed*4,y) hspeed=-hspeed
if !place_free(x,y+vspeed*4) or scrMeetDoor(x,y+vspeed*4) vspeed=-vspeed
}
...
if place_meeting(x+lengthdir_x(16,dir),y+lengthdir_y(16,dir),global.my_id) or place_meeting(x,y,global.my_id) global.test=1
}
}
if global.test=1 {
