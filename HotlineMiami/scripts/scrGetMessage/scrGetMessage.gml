function scrGetMessage(argument0) {
	if (global.maskindex == 19 && global.maskon) {
	    ...
	    if (room == rmHospitalTopFloor || room == rmHospitalEntrance) {
	        if (argument0 == 0) {
