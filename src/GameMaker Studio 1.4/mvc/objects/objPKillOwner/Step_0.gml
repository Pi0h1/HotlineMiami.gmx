if image_index<82 image_index+=0.15 else {
...
if wait>0 wait-=1
if (round(image_index)=3 or round(image_index)=8 or round(image_index)=13 or round(image_index)=18 or round(image_index)=23) and wait=0 {
wait=10
...
if (round(image_index)=28 or round(image_index)=33 or round(image_index)=38) and wait=0 {
bled=1
wait=10
hurtindex=1
targetindex=3
...
if (round(image_index)=46 or round(image_index)=53 or round(image_index)=60) and wait=0 {
bled=1
wait=10
hurtindex=1
targetindex=3
...
if round(image_index)=72 and wait=0 {
bled=1
wait=10
hurtindex=1
targetindex=3
...
audio_play_sound(sndHit,0,false)
audio_play_sound(sndPunch,0,false)
if global.done=0 instance_create(x,y,objLevelComplete) global.done=1
repeat (8) {
instance_create(x+lengthdir_x(21,image_angle)-1+random(2),y+lengthdir_y(21,image_angle)-1+random(2),objBloodSquirt)
}
repeat (12) {
