...
if point_distance(0,0,rightthumb_x(0),-rightthumb_y(0))>12000 mousedir=point_direction(0,0,rightthumb_x(0),-rightthumb_y(0)) else
{
...
draw_set_blend_mode(bm_subtract)
draw_circle_color(camera_get_view_width(view_camera[0])/2,camera_get_view_height(view_camera[0])/2,240+random(24)+24,merge_color(c_black,merge_color(c_white,c_aqua,0.6+lengthdir_x(0.4,global.dir*4)),bamount),merge_color(c_black,c_white,bamount),0)
draw_set_blend_mode(bm_normal)
