...
if (image_index < 8) {
    ...
    if (image_index >= 2)
        draw_sprite_ext(sprBottleExplodeFlame, image_index - 2, x, y, image_xscale, image_yscale, image_angle, c_orange, 1);
    if (image_index >= 1)
        draw_sprite_ext(sprBottleExplodeFlame, image_index - 1, x, y, image_xscale, image_yscale, image_angle, c_yellow, 1);
