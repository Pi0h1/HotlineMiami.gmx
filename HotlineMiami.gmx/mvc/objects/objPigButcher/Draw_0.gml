...
if (sprite_index == sprPigButcher || sprite_index == sprPigButcherAttack || sprite_index == sprPigButcherWalkMP5 || sprite_index == sprPigButcherShoot)
    exit;
