...
image_yscale = 1.5;
bullets = 0;
energie--; // Reduce health
// Create blood Smoke when shot
with(objEBullet) {
...
test = 0;
// Create blood effects when shot
repeat(2 * bullets) {
...
// Kill player, if hit by shotgun, random chance, or player runs out of health
if (bullets > 1 or round(random(1)) || energie < 0) {
    // Create player dead body sprite
