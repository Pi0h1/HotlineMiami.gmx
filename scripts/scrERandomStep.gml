...
image_speed=(speed*0.1)*delta
if !place_free(x+hspeed*4,y) hspeed=-(hspeed)*delta
if !place_free(x,y+vspeed*4) vspeed=-(vspeed)*delta
scrGoGetWeapon()
} else {
if alert=0 {
...
if scrIsSearching(sprite_index) {image_speed=(0.2)*delta speed=0 exit}
