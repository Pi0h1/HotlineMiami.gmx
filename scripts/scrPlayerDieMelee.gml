...
if global.my_id.sprite_index=sprEAttackClub or global.my_id.sprite_index=sprPAttackClub or global.my_id.sprite_index=sprPWalkClub or global.my_id.sprite_index=sprPoliceAttackNightStick or global.my_id.sprite_index=sprHoboAttack or global.my_id.sprite_index=sprEAttackBat or global.my_id.sprite_index=sprEAttackPipe {PlaySFX(sndHit) my_id.sprite_index=choose(sprPBackBlunt,sprPBackBlunt,sprPFrontBlunt)} 
if global.my_id.sprite_index=sprEAttackKnife or global.my_id.sprite_index=sprPantherHitback or global.my_id.sprite_index=sprBodyguardAttack or global.my_id.sprite_index=sprBoss2AttackCleaver or global.my_id.sprite_index=sprCleaver {my_id.sprite_index=sprPBackCut PlaySFX("Light Cut")}
if global.my_id.sprite_index=sprEFatAttack or global.my_id.sprite_index=sprBoss1Attack {my_id.sprite_index=choose(sprPBackBlunt,sprPBackBlunt,sprPFrontBlunt) PlaySFX("Blunt")}
...
if sprite_index=sprPWalkUnarmed or sprite_index=sprPAttackUnarmed or object_index=objPlayerBiker or sprite_index=sprPWalkBag or sprite_index=sprPAttackBag or sprite_index=sprPBagKill noweapon=1 else noweapon=0
if noweapon=0 {
