...
darkcolor=merge_color(merge_color(c_black,c_maroon,random(1)),merge_color(c_red,c_orange,random(1)),0.5-lengthdir_x(0.5,start_x*0.25-pointx*1.5))
...
ii=0
repeat dist {
if dist>1 draw_set_color(merge_color(c_orange,c_white,ii*(1/15))) else draw_set_color(merge_color(merge_color(c_orange,c_maroon,random(1)),darkcolor,amount[i]))
