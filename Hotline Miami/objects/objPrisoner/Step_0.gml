...
if objPlayer.y<192 and objPlayer.x>488 alert=0 else alert=1
}
...
if on=1 {
if speed>0 image_speed=0.1 else {image_speed=0 image_index=0} 
if !place_free(x+hspeed,y) and speed>0 {turn=!turn speed=0} else
{
if speed=0 {
if turn {if direction<180 direction+=10 else speed=0.5}
if !turn {if direction<350 direction+=10 else {direction=0 speed=0.5}}
}
}
...
if objPlayer.sprite_index=sprPAttackNightStick or objPlayer.sprite_index=sprPAttackPunch {
global.test=0 
with objPlayer {
if place_meeting(objPlayer.x+lengthdir_x(12,objPlayer.dir),objPlayer.y+lengthdir_y(12,objPlayer.dir),objPrisoner) global.test=1
}
if global.test=1 {
global.shake=7
