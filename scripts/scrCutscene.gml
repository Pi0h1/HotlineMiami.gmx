...
} else {if next=1 {if newsong=1 {sxeasy_stop(1) if room=rmDream1 sxeasy_setVolume(0) sxeasy_play(song);} if room=rmTutorial sxeasy_stop(1) room=nextroom} else {scrResetSurfaces() LoadGameState()}}}
}
coldir+=1
