...
d3d_set_fog(0,0,0,0)
if instance_number(objESubwayStatic)+instance_number(objSubwayKnockedOut)+instance_number(objEnemy)=0 draw_sprite_ext(sprArrow,0,x,y-12+lengthdir_x(4,dir*2),1,1,0,c_white,1)
dir+=4
