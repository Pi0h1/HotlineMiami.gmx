dir += 0.65;
color2 = c_black;
color1 = merge_color(c_white, merge_color(merge_color(c_aqua, c_teal, 0.5 + lengthdir_x(0.5, dir * 3.12)), c_blue, 0.125 + lengthdir_y(0.125, dir * 1.73)), 0.5 + lengthdir_y(0.5, dir * 1.73));
