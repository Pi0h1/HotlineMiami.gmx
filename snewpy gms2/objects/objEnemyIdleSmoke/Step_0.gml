...
if room=rmTrainstationEntrance my_id=instance_create(x,y,objEnemyMeleeStationary) else my_id=instance_create(x,y,choose(objEnemy,objEnemyMeleeStationary))
my_id.alert=1
