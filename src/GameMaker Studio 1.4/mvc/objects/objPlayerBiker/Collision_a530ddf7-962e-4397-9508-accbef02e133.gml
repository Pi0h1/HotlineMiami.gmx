...
if bullets>1 my_id.sprite_index=sprMCBackShotgun else my_id.sprite_index=sprMCBackMachinegun
my_id.image_index=1+floor(random(4))
my_id.direction=edir
my_id.speed=1.5+random(1)+bullets*0.15
my_id.image_angle=my_id.direction
nohelmet=1
if my_id.sprite_index=sprMCFrontBlunt or sprite_index=sprMCBackBlunt nohelmet=0
if nohelmet=0 {
