...
if sprite_index=sprPWalkMachete     {Melee (00.5 ,12,sndHitWall )}
...
if sprite_index=sprPWalkSword       {Melee (0001 ,15,sndHitWall )}
if sprite_index=sprPWalkKnife       {Melee (0001 ,10,sndHitWall )}
if sprite_index=sprPWalkClub        {Melee (00.7 ,19,sndHitWall )}
if sprite_index=sprPWalkNightStick  {Melee (00.7 ,15,sndHitWall )}
if sprite_index=sprPWalkPipe        {Melee (00.7 ,22,sndHitWall )}
