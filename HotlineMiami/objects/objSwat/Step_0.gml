...
if (!instance_exists(objPlayer)) {
    ...
    if (objPlayer.sprite_index == sprPAttackPunch || objPlayer.sprite_index == sprPAttackClub or objPlayer.sprite_index = sprPAttackBat or objPlayer.sprite_index = sprPAttackKnife or objPlayer.sprite_index = sprPAttackPipe or objPlayer.sprite_index = sprPAttackPool or objPlayer.sprite_index = sprPAttackAxe or objPlayer.sprite_index = sprPAttackSword or objPlayer.sprite_index = sprPAttackSledgeHammer or objPlayer.sprite_index = sprPAttackPan or objPlayer.sprite_index = sprPAttackPot or objPlayer.sprite_index == sprPAttackMachete || objPlayer.sprite_index == sprPAttackDrill) {
