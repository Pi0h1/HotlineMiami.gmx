...
if global.throw=0 and image_index>16 {my_id=instance_create(x-12,y,objMaskDrop) my_id.direction=180+random(10) my_id.speed=3 my_id.image_angle=270 my_id.sprite_index=sprMaskDropBack global.throw=1}
}
}
}
