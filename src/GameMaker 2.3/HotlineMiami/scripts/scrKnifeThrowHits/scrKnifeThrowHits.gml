function scrKnifeThrowHits() {
	...
	if noweapon=0 {
	my_id.text="+"+string((800)*scrGetFactor())+"pts"
	global.myscore+=(800)*scrGetFactor()
	...
	my_id.text="+"+string((300)*scrGetFactor())+"pts"
	global.myscore+=(300)*scrGetFactor()
	global.boldscore+=300*scrGetFactor()
	}
	instance_destroy()
