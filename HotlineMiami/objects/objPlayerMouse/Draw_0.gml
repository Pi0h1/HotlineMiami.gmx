...
// Create a circular light around the player (primarily used to create a muzzleflash effect)
...
// Decrement timer for when player can shoot again.
if (reload > 0)
    reload--;

// Reduce flash that appears when shooitng
if (light > 3)
    light -= 3;

    // Render throwing item when holding a throwing weapon    
