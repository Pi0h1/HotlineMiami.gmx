...
draw_set_font(fntScore)
if ammoy>-32 draw_text_transformed(18+string_width(string_hash_to_newline(ammostring))*0.5+lengthdir_x(1,dir),__view_get( e__VW.HView, 0 )-ammoy+lengthdir_y(1,dir),string_hash_to_newline(ammostring),1,1,lengthdir_x(2,dir))
draw_set_color(color2)
if ammoy>-32 draw_text_transformed(18+string_width(string_hash_to_newline(ammostring))*0.5+lengthdir_x(1,dir-180),__view_get( e__VW.HView, 0 )-ammoy+lengthdir_y(1,dir-180),string_hash_to_newline(ammostring),1,1,lengthdir_x(2,dir-10))
}
}
